...
public class OrderUtil {
	...
	public static boolean isCreateStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_CREATE == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isPayStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_PAY == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isShipStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_SHIP == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isConfirmStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_CONFIRM == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isCancelStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_CANCEL == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isAutoCancelStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_AUTO_CANCEL == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isRefundStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_REFUND == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isRefundConfirmStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_REFUND_CONFIRM == dtsOrder.getOrderStatus().shortValue();
	}

	public static boolean isAutoConfirmStatus(DtsOrder dtsOrder) {
		return cn.forbearance.mall.util.OrderUtil.STATUS_AUTO_CONFIRM == dtsOrder.getOrderStatus().shortValue();
	}
