package cn.forbearance.mall.qcode;

import cn.binarywang.wx.miniapp.api.WxMaService;
import cn.forbearance.mall.storage.StorageService;
...
public class QCodeService {
	private static final Logger logger = LoggerFactory.getLogger(cn.forbearance.mall.qcode.QCodeService.class);
