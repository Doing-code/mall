...
import cn.forbearance.mall.dao.DtsAccountTraceMapper;
import cn.forbearance.mall.dao.DtsUserAccountMapper;
import cn.forbearance.mall.dao.DtsUserMapper;
import cn.forbearance.mall.dao.ex.AccountMapperEx;
...
public class DtsAccountService {
	...
	private final static Log logger = LogFactory.getLog(cn.forbearance.mall.service.DtsAccountService.class);
