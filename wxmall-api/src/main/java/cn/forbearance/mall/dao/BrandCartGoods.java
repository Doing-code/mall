...
public class BrandCartGoods implements Serializable {
	...
	public static cn.forbearance.mall.dao.BrandCartGoods init(DtsBrand dtsBrand) {
		cn.forbearance.mall.dao.BrandCartGoods bcg = new cn.forbearance.mall.dao.BrandCartGoods();
		if (dtsBrand != null) {
