package cn.forbearance.mall.system;

import cn.forbearance.mall.util.SystemInfoPrinter;
...
//	@PostConstruct
	...
	private Map<String, String> getSystemInfo() {
		...
		infos.put("调试级别", environment.getProperty("logging.level.cn.forbearance.mall"));
