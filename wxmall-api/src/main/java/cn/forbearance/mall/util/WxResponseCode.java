...
public enum WxResponseCode {
	...
	public static cn.forbearance.mall.util.WxResponseCode getInstance(Integer code) {
		if (code != null) {
			for (cn.forbearance.mall.util.WxResponseCode tmp : cn.forbearance.mall.util.WxResponseCode.values()) {
