...
import cn.forbearance.mall.pojo.DtsAddress;
import cn.forbearance.mall.pojo.DtsRegion;
import cn.forbearance.mall.service.DtsAddressService;
import cn.forbearance.mall.service.DtsRegionService;
import cn.forbearance.mall.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
    ...
    public Object list(@LoginUser Integer userId) {
        logger.info("【请求开始】获取收货地址列表,请求参数,userId：{}", "null");
        if (userId == null) {
